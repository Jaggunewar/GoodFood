...
namespace GoodFood
{
    public partial class _OrderItems : Page
    {
        ...
        public void BindCustomer()
        {
            ...
            ddlCustomer.Items.Insert(0, new ListItem { Text = "--Select Customer--", Value = "" });

          

        }
        protected void ddlCustomer_OnSelectedChanged(object sender, EventArgs e)
        {
           BindGridDetails();
        }
        ...
        {
            // objOrder.CustomerId = "89402f7e-7434-4d60-b50c-62ae963db31d";

            if (!String.IsNullOrEmpty(ddlCustomer.SelectedValue.ToString()))
            {
                objOrder.CustomerId = ddlCustomer.SelectedValue;
             ...
             DataTable dtFoods = objOrder.SelectDishTotal();
