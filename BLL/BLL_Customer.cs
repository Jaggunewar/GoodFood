...
namespace GoodFood.BLL
{
    public class BLL_Customer
    {
        ...
        public DataTable Select(string id)
        {
            ...
            { 
                cmd.CommandText = "SELECT * FROM Customer where CustomerId='"+id.ToString()+"'";
        ...
        public string Insert()
        {
            ...
            try
            {
                ...
                {
                    using (OracleCommand cmd = new OracleCommand("Insert into Customer(CustomerId, CustomerName, PhoneNumber)Values('" + this.CustomerId + "','" + this.CustomerName + "','" + this.PhoneNumber + "')"))
                    {
                        cmd.Connection = con;
                        con.Open();
                        cmd.ExecuteNonQuery();
        ...
        public string Update()
        {
            try
            {
                ...
                using (OracleConnection con = new OracleConnection(constr))
                {
                    using (OracleCommand cmd = new OracleCommand(@"update Customer set
        ...
        public string Delete()
        {
            ...
            try
            {
                ...
                using (OracleConnection con = new OracleConnection(constr))
                {
                    ...
                    using (OracleCommand cmd = new OracleCommand("DELETE FROM Customer WHERE CustomerId ='" + this.CustomerId+"'"))
                    {
